...
If you only build one more thing, build the operator experience around the current
protocol:

- clearer setup checks
- reverse proxy helpers
- a dashboard
- better status visibility
- easier worker onboarding

That would take `decent` from “interesting prototype” to “something people can
actually try with friends.”
